...
Usage simple (racine contenant les sous-dossiers Collins, Krogan14K, …) :
    python go_enrichment_scores.py /path/to/results_root

Usage avec un seul dossier (pas de sous-dossiers) :
    python go_enrichment_scores.py /path/to/one_dataset
"""
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.exit("Usage: python go_enrichment_scores.py <chemin_dossier_racine>")
    main(sys.argv[1])
